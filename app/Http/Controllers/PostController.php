...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($posts) {
            ...
            $red = redirect('posts/create')->with('failed', 'Input Data failed, Please try again');
        }
        return $red;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($posts) {
            ...
            $red = redirect('posts/edit/'.$id)->with('failed', 'Input Data failed, Please try again');
        }
        return $red;
    }
    ...
    public function destroy($id)
    {
        ...
        $red = redirect('posts')->with('success', 'Data has been deleted');
        return $red;
    }
    public function deleteall(Request $request)
    {
        ...
        if ($dbs) {
            $red = redirect('posts')->with('success', 'Data(s) has been Deleted');
        }else{
            $red = redirect('posts')->with('failed', 'Deletion of Data failed, Please try again');
        }
        return $red;
    }
}
